...
#define myAuth_h
#ifdef HAVEI2C
    const   char        blynkAuth[]     = "4f1de4949e4c4020882efd3e61bdd6cd"; // PhotonTHermo9HYK thermostat
#else
    const   char        blynkAuth[]     = "d2140898f7b94373a7868f158a3403a1"; // PhotonExp9HYK unconnected photon
#endif
